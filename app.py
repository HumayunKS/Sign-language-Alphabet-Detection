...
THRESHOLD = 60
json_file = open(r"C:\Users\humtw\OneDrive\Desktop\University Files\Semester 7\Machine Learning\Project\new test\Sign-Language-Translator\signlanguagedetectionmodel48x48.json")
model_json = json_file.read()
json_file.close()
model = model_from_json(model_json)
model.load_weights(r"C:\Users\humtw\OneDrive\Desktop\University Files\Semester 7\Machine Learning\Project\new test\Sign-Language-Translator\signlanguagedetectionmodel48x48.keras")

# model = tf.keras.models.load_model(r'C:\Users\humtw\OneDrive\Desktop\University Files\Semester 7\Machine Learning\Project\new test\Sign-Language-Translator\1_vgg16_full_model.keras')
...
class App():
    ...
    def __init__(self):
        ...
        self.active = 0
        self.eraseimg = Image.open(r"C:\Users\humtw\OneDrive\Desktop\University Files\Semester 7\Machine Learning\Project\new test\Sign-Language-Translator\pic.jpg")
    ...
    def predict(self):
        labels = ['A', 'B', 'C', 'D', 'E', 'F', 
         'G', 'H', 'I', 'J', 'K', 'L', 'Malevolent Shrine', 
         'N' , 'P', 'Q', 'R','Rock', 'S','Ship', 'O',
         'T','Triangle', 'U', 'V', 'W', 'X', 'Y', 'Z']

        frame = cv2.imread("capture.jpg")
        
        cropframe=cv2.cvtColor(frame,cv2.COLOR_BGR2GRAY )
        # cropframe = cv2.resize(frame,(224,224))
